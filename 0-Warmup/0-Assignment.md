...
3. Please provide a link to the repository you are using for this class.
    ...
    https://github.com/alisemihural/CS283

4. Briefly describe what you want to get out of this class.

    I hope to be more informed about the interaction of hardware and software better. I am also curious about concurrent programming, network programming and embedded C. I want to grasp these topics well until end of this class.

5. Briefly describe any concerns you might be having with being successful in this class (if any).

    I don't have any concerns. Maybe the scale of the homeworks. Systems Architecture class required some time for certain homeworks, but it was manageable. I hope it will be the same for this class as well.
